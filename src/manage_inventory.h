...
static inline bool add_to_inventory(shared_ptr<gamestate> g, entityid actor_id, entityid item_id) {
...
static inline bool is_in_inventory(shared_ptr<gamestate> g, entityid actor_id, entityid item_id) {
    auto maybe_inventory = g->ct.get<inventory>(actor_id);
    if (!maybe_inventory.has_value()) {
...
static inline bool remove_from_inventory(shared_ptr<gamestate> g, entityid actor_id, entityid item_id) {
...
static inline bool drop_from_inventory(shared_ptr<gamestate> g, entityid actor_id, entityid item_id) {
...
static inline bool drop_all_from_inventory(shared_ptr<gamestate> g, entityid actor_id) {
