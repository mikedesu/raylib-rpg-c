...
#define TX_BUCKLER_KEY_COUNT 2
static int TX_BUCKLER_KEYS[TX_BUCKLER_KEY_COUNT] = {
    TX_BUCKLER,
    TX_GUARD_BUCKLER_FRONT,
};

//#define TX_GUARD_BUCKLER_FRONT_KEY_COUNT 1
//static int TX_GUARD_BUCKLER_FRONT_KEYS[TX_GUARD_BUCKLER_FRONT_KEY_COUNT] = {TX_GUARD_BUCKLER_FRONT};

//#define TX_GUARD_BUCKLER_BACK_KEY_COUNT 1
//static int TX_GUARD_BUCKLER_BACK_KEYS[TX_GUARD_BUCKLER_BACK_KEY_COUNT] = {TX_GUARD_BUCKLER_BACK};
