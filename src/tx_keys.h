...
//#define TX_GUARD_WOODEN_SHIELD_KEY_COUNT 2
//static int TX_GUARD_WOODEN_SHIELD_KEYS[TX_GUARD_WOODEN_SHIELD_KEY_COUNT] = {
//    TX_GUARD_WOODEN_SHIELD_FRONT,
//    TX_GUARD_WOODEN_SHIELD_BACK,
//};
