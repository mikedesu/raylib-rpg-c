...
void dungeon_tile_init(dungeon_tile_t* tile, const dungeon_tile_type_t type) {
    ...
    tile->pressure_plate_texture_key = -1;
...
void dungeon_tile_set_pressure_plate_texture_key(dungeon_tile_t* tile, const int key) {
    if (!tile) {
        merror("dungeon_tile_set_pressure_plate_texture_key: tile is NULL");
        return;
    }
    tile->pressure_plate_texture_key = key;
}
...
const int dungeon_tile_get_pressure_plate_texture_key(const dungeon_tile_t* tile) {
    ...
    return tile->pressure_plate_texture_key;
}
