...
static inline entityid create_spell_with(shared_ptr<gamestate> g, function<void(shared_ptr<gamestate>, entityid)> spellInitFunction) {
...
static inline entityid create_spell_at_with(shared_ptr<gamestate> g, vec3 loc, function<void(shared_ptr<gamestate>, entityid)> spellInitFunction) {
