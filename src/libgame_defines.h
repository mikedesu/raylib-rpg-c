...
#define TX_GUARD_WOODEN_SHIELD_FRONT 70
#define TX_GUARD_WOODEN_SHIELD_BACK 71
#define TX_GUARD_WOODEN_SHIELD_SUCCESS_FRONT 72
#define TX_GUARD_WOODEN_SHIELD_SUCCESS_FRONT_SHADOW 73
